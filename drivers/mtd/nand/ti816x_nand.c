 ...
 *
 */
static void ti816x_hwecc_init(struct nand_chip *chip)
{
	/*
 ...
 * Further details can be had from TI816x TRM and the following selected links:
 ...
 */
static int ti816x_correct_data(struct mtd_info *mtd, uint8_t *dat,
 ...
 */
static int ti816x_calculate_ecc(struct mtd_info *mtd, const uint8_t *dat,
				uint8_t *ecc_code)
{
	u_int32_t val;
...
/*
 * ti816x_enable_ecc - This function enables the hardware ecc functionality
 * @mtd:        MTD device structure
 * @mode:       Read/Write mode
 */
static void ti816x_enable_hwecc(struct mtd_info *mtd, int32_t mode)
{
...
/*
 * ti816x_nand_switch_ecc - switch the ECC operation b/w h/w ecc and s/w ecc.
 * The default is to come up on s/w ecc
 *
 * @hardware - 1 -switch to h/w ecc, 0 - s/w ecc
 *
 */
void ti816x_nand_switch_ecc(int32_t hardware)
{
	...
	if (hardware) {
		...
		nand->ecc.size = 512;
		nand->ecc.bytes = 3;
		nand->ecc.hwctl = ti816x_enable_hwecc;
