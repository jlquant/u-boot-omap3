...
#define TI816X_SMRT_SCALE_ADDR			(TI816X_CTRL_BASE + 0x06A0)
#define TI816X_SMRT_OPP_SVT_ADDR		(TI816X_CTRL_BASE + 0x06A8)
#define TI816X_SMRT_OPP_HVT_ADDR		(TI816X_CTRL_BASE + 0x06AC)
